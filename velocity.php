...
<head>
    ...
    <link href="lib/css/materialize.css" rel="stylesheet">
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Roboto" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Lato" rel="stylesheet">
    <link rel="canonical" href="https://codepen.io/designcouch/pen/obvKxm">
<?php
...
?>
      <div class="container">
        ...
        <div class="modExample">
          ...
          <?php for ($i = 0; $i < 9; ++$i): ?>
            <a href="#myModal<?php print_r($i) ; ?>" role="button" data-target="#myModal<?php print_r($i) ; ?>" class="btn waves-effect waves-orange orange accent-4" data-toggle="modal">fadeIn</a>
          <div id="myModal<?php print_r($i) ; ?>" class="modal orange accent-4" data-easein="fadeIn" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="material-icons">cancel</i></button>
                  <h6 class="modal-title" id="myModalLabel">BMW Previews Next-Gen 4 Series And I4</h6>
                </div>
                    ...
                    <div class="col s12 m12">
                      <div class="card">
                        <div class="card-image">
                          <img src="images/cars/2021-BMW-M3-Pure-Horsepower-New-Concept.PNG" alt="BMW M4">
                        </div>
                        <div class="card-content">
                          <p>  <span class="card-title">BMW Previews Next-Gen 4 Series And I4</span></p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="modal-footer">
                  <button class="btn btn-default cyan accent-4" data-dismiss="modal" aria-hidden="true">Close</button>
                  <button class="btn btn-primary cyan accent-4">Save changes</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <a href="#myModal1" role="button" data-target="#myModal1" class="btn waves-effect waves-orange cyan accent-4" data-toggle="modal">fadeIn</a>
          <div id="myModal1" class="modal cyan accent-4" data-easein="fadeIn" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="material-icons">cancel</i></button>
          ...
          <a href="#myModal2" role="button" data-target="#myModal2" class="btn waves-effect waves-orange cyan accent-4" data-toggle="modal">flipXIn</a>
          <div id="myModal2" class="modal cyan accent-4" data-easein="flipXIn" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="material-icons">cancel</i></button>
                  <h6 class="modal-title" id="myModalLabel">New BMW M4 Concept Looks Like A Baby M8</h6>
                </div>
                <div class="modal-body">
                 <div class="row">
                    <div class="col s12 m12">
                      <div class="card">
                        <div class="card-image">
                          <img src="images/cars/new-bmw-m4-concept-looks-like-a-baby-m8-137893-7.jpg" alt="BMW M4">
                        </div>
                        <div class="card-content">
                          <p>  <span class="card-title">New BMW M4 Concept Looks Like A Baby M8</span></p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <a href="#myModal3" role="button" data-target="#myModal3" class="btn waves-effect waves-orange cyan accent-4" data-toggle="modal">flipXIn</a>
          <div id="myModal3" class="modal cyan accent-4" data-easein="flipXIn" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="material-icons">cancel</i></button>
                  <h6 class="modal-title" id="myModalLabel">BMW Previews Next-Gen 4 Series</h6>
                </div>
                <div class="modal-body">
                 <div class="row">
                    <div class="col s12 m12">
                      <div class="card">
                        <div class="card-image">
                          <img src="images/cars/Capture1.PNG" alt="BMW M4">
                        </div>
                        <div class="card-content">
                          <p>  <span class="card-title">BMW Previews Next-Gen 4 Series</span></p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <a href="#myModal4" role="button" data-target="#myModal4" class="btn waves-effect waves-orange cyan accent-4" data-toggle="modal">flipBounceXIn</a>
          <div id="myModal4" class="modal cyan accent-4" data-easein="flipBounceXIn" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="material-icons">cancel</i></button>
                  <h6 class="modal-title" id="myModalLabel">BMW Concept Previewing Next 4 Series In</h6>
                </div>
                <div class="modal-body">
                 <div class="row">
                    <div class="col s12 m12">
                      <div class="card">
                        <div class="card-image">
                          <img src="images/cars/bmw-concept-4-04.jpg" alt="BMW M4">
                        </div>
                        <div class="card-content">
                          <p>  <span class="card-title">BMW Concept Previewing Next 4 Series In</span></p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <a href="#myModal5" role="button" data-target="#myModal5" class="btn waves-effect waves-orange cyan accent-4" data-toggle="modal">flipBounceYIn</a>
          <div id="myModal5" class="modal cyan accent-4" data-easein="flipBounceYIn" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="material-icons">cancel</i></button>
                  <h6 class="modal-title" id="myModalLabel">New BMW 4 Series Convertible Rendered</h6>
                </div>
                <div class="modal-body">
                 <div class="row">
                    <div class="col s12 m12">
                      <div class="card">
                        <div class="card-image">
                          <img src="images/cars/62245e8d48fc58da1c620055ce7b8821.png" alt="BMW M4">
                        </div>
                        <div class="card-content">
                          <p>  <span class="card-title">New BMW 4 Series Convertible Rendered</span></p>
                        </div>
                      </div>
                    </div>
                  </div>
...
<script type="text/javascript" src="lib/js/modal_v.js"></script>
</html>
